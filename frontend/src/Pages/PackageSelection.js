          ...
          <div className="space-y-6 max-w-3xl mx-auto">
            <div>
              ...
              <p className="text-gray-600">
                Chúng tôi sử dụng cổng thanh toán VNPay - một trong những nền tảng thanh toán uy tín nhất Việt Nam.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">
                Có thể hủy gói VIP không?
              </h3>
              <p className="text-gray-600">
                Bạn có thể sử dụng gói VIP cho đến hết thời hạn đã mua. Chúng tôi không hỗ trợ hoàn tiền.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">
                Tôi có thể gia hạn tự động không?
              </h3>
              <p className="text-gray-600">
                Hiện tại chúng tôi chưa hỗ trợ gia hạn tự động. Bạn cần mua lại gói mới khi hết hạn.
              </p>
            </div>
          </div>
        </div>
